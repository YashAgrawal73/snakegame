...
public class Board extends JPanel implements ActionListener{
    ...
    private final int RANDOM_POSITOIN = 29;
    private int apple_x;
    private int apple_y;
    ...
    public void locateApple(){
        int r=(int)(Math.random()*RANDOM_POSITOIN);
        apple_x=r*DOT_SIZE;
        
        r=(int)(Math.random()*RANDOM_POSITOIN);
        apple_y=r*DOT_SIZE;
    }
    ...
    public void gemeOver(Graphics g){
